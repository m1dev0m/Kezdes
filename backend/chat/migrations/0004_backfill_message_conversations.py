...
def forwards(apps, schema_editor):
    ...
    # Backfill conversation for existing messages where possible.
    # Strategy:
    # - If message has booking with user+restaurant: conversation = (restaurant, booking.user)
    # - Else if message has restaurant: conversation = (restaurant, sender)
    # Keep message.booking/restaurant unchanged.
