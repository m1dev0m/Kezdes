...
const styles = StyleSheet.create({
    ...
    itemImage: { width: 70, height: 70, borderRadius: 40, backgroundColor: colors.surface },
    ...
    cartBadge: { width: 28, height: 28, borderRadius: 40, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
