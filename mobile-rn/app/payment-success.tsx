...
const styles = StyleSheet.create({
    ...
    detailsCard: { width: '100%', backgroundColor: colors.surface, borderRadius: 24, padding: 24, marginBottom: 40, borderWidth: 1, borderColor: colors.border },
    ...
    mainBtn: { backgroundColor: colors.primary, width: '100%', paddingVertical: 18, borderRadius: 16, alignItems: 'center', marginBottom: 16 },
    mainBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
    secondaryBtn: { width: '100%', paddingVertical: 18, borderRadius: 16, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
