...
const styles = StyleSheet.create({
    ...
    hero: { padding: 24, backgroundColor: colors.surface, marginHorizontal: 20, borderRadius: 40, alignItems: 'center', marginBottom: 32 },
    ...
    topicCard: { width: '48%', backgroundColor: '#fff', borderRadius: 32, borderWidth: 1, borderColor: colors.border, padding: 20, alignItems: 'center' },
    ...
    contactBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', padding: 16, borderRadius: 32, borderWidth: 1, borderColor: colors.border, marginBottom: 12 },
