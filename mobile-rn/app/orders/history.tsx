...
export default function OrderHistoryScreen() {
    ...
    const loadOrders = async () => {
        ...
        try {
            const data = await fetchOrders(user.access);
            setOrders(data);
        } catch (error) {
        ...
        <View style={styles.card}>
            <View style={styles.cardHeader}>
                <View>
                    ...
                    <Text style={styles.orderDate}>{new Date(item.created_at).toLocaleDateString('ru-RU', { day: 'numeric', month: 'long', hour: '2-digit', minute: '2-digit' })}</Text>
                </View>
