...
const styles = StyleSheet.create({
    ...
    summaryCard: { backgroundColor: '#FFFFFF', borderRadius: 40, overflow: 'hidden', borderWidth: 1, borderColor: '#F0F0F0', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 12, elevation: 4, marginBottom: 32 },
    venueImage: { width: '100%', height: 140 },
    summaryContent: { padding: 20, alignItems: 'center' },
    badgeSuccess: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#E8F5E9', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 40, gap: 6, marginBottom: 12 },
    ...
    statsRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F8F9FA', paddingVertical: 12, paddingHorizontal: 20, borderRadius: 32, width: '100%', justifyContent: 'center', marginBottom: 20 },
    ...
    actionButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', height: 52, backgroundColor: 'rgba(0, 71, 255, 0.1)', borderRadius: 32, gap: 8 },
    ...
    timelineDot: { width: 16, height: 16, borderRadius: 32, borderWidth: 2, backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center' },
