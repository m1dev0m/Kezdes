...
const styles = StyleSheet.create({
    ...
    dateTimeCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, padding: 20, borderRadius: 32, borderWidth: 1, borderColor: colors.border },
    dateTimeValue: { flex: 1, marginLeft: 16, fontSize: 16, fontWeight: '600', color: colors.text },
    changeBtn: { paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#fff', borderRadius: 32, borderWidth: 1, borderColor: colors.border },
    changeBtnText: { fontSize: 13, fontWeight: '700', color: colors.primary },
    timeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
    timeChip: { width: '30%', height: 48, borderRadius: 40, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.border },
    ...
    nextBtn: { flex: 1, height: 56, backgroundColor: colors.primary, borderRadius: 32, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
