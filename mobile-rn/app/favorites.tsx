...
const styles = StyleSheet.create({
    ...
    list: { padding: 16 },
    card: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 32, borderWidth: 1, borderColor: colors.border, padding: 12, marginBottom: 16 },
    imageBox: { width: 100, height: 100, borderRadius: 40, backgroundColor: colors.surface, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
    favBtn: { position: 'absolute', top: 8, right: 8, backgroundColor: '#fff', padding: 4, borderRadius: 32 },
