...
const styles = StyleSheet.create({
    ...
    qrBox: { padding: 20, backgroundColor: '#fff', borderRadius: 24, borderWidth: 1, borderColor: colors.border, marginBottom: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.05, shadowRadius: 20, elevation: 5 },
    ...
    infoBox: { flexDirection: 'row', backgroundColor: colors.surface, padding: 16, borderRadius: 16, alignItems: 'center', gap: 12 },
    infoText: { flex: 1, fontSize: 13, color: colors.textSecondary, lineHeight: 18 },
    historyBtn: { marginTop: 'auto', marginBottom: 40, paddingVertical: 16, paddingHorizontal: 32, borderRadius: 16, backgroundColor: colors.surface },
