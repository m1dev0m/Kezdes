...
const styles = StyleSheet.create({
    ...
    content: { padding: 24 },
    statusCard: { backgroundColor: '#f0fdf4', padding: 20, borderRadius: 24, borderWidth: 1, borderColor: '#dcfce7', marginBottom: 32 },
    ...
    benefitItem: { flexDirection: 'row', alignItems: 'center', gap: 16, marginBottom: 16, backgroundColor: colors.surface, padding: 16, borderRadius: 16 },
    benefitText: { fontSize: 14, color: colors.text, fontWeight: '600' },
    docsSection: {},
    docItem: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 16, backgroundColor: colors.surface, borderRadius: 16, borderWidth: 1, borderColor: colors.border },
