...
const styles = StyleSheet.create({
    ...
    input: { backgroundColor: colors.surface, padding: 16, borderRadius: 32, fontSize: 15, borderWidth: 1, borderColor: colors.border, color: colors.text },
    inputError: { borderColor: colors.error },
    errorText: { marginTop: 6, marginLeft: 4, fontSize: 12, fontWeight: '600', color: colors.error },
    row: { flexDirection: 'row', gap: 16 },
    selectBtn: { backgroundColor: colors.surface, padding: 16, borderRadius: 32, borderWidth: 1, borderColor: colors.border, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    selectText: { fontSize: 15, color: colors.text, fontWeight: '500' },
    submitBtn: { backgroundColor: colors.primary, paddingVertical: 18, borderRadius: 32, alignItems: 'center', marginTop: 20, shadowColor: colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
